    ...
    <div class="wrapper">
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                @section('page_name', 'Update Projects')
            ...
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h6 class="mb-0 text-uppercase">Update your existing project</h6>
                    <hr />
                            ...
                            <form class="row g-3" method="POST" action="{{ route('project.update') }}"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input type="text" class="form-control" id="myTextbox" name="title" value="{{ $project->title }}"
                                            required placeholder="Package Title">
                                    </div>

                                    <input hidden type="text" class="form-control" id="mySlugbox" name="slug"
                                    required placeholder="Package Title Slag" value="{{$project->slug}}" readonly>


                                    <div class="form-row mt-3">
                                        <label for="input1" class="form-label">Category</label>
                                    <select class="form-select mb-3" aria-label="Default select example" name="category_id">
                                        <option selected value="{{$project->category_id}}">{{$project->category->name}}</option>
                                    ...
                                    <div class="form-row mt-3">
                                        ...
                                        <input type="number" class="form-control" name="project_year" required value="{{ $project->project_year }}"
                                    ...
                                    <div class="form-row mt-3">
                                        ...
                                        <img id="blah" src="{{ asset($project->image) }}"
                                    ...
                                    <div class="form-row mt-3">
                                        ...
                                        <textarea id="myeditorinstance" name="description" required>{{$project->description}}</textarea>
                                    </div>
